    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Container(
          ...
          child: Center(
            child: SingleChildScrollView(child: setUsernameScreenBody()),
          ),
        ),
      )
    );
...
//---------Body----------------
  ...
  Column setUsernameScreenBody() {
    return Column(
      children: [
        title(" Change Username"),
        note("Temp Username"),
        whiteDivider(),
        message("Confirm your changes to your username."),
        whiteDivider(),
        Column(
          children: [
  ...
  Container noteUsername(var username){
    return Container(
      alignment: Alignment.center,
